...
"""Prefetch dependencies into the cache/store and write/update the lockfile."""
...
def prefetch(
    *,
    ...
    """Resolve + fetch deps and write a lockfile.

    Unlike `install()`, this does not enforce trust decisions; it is intended
    for offline preparation and CI caching.
    """
